...
#####
CSV_COLUMNS = ('label_neu', 'voice', 'intplan', 'nummailmes', '_tdmin', '_tdcal',
               '_tdchar', '_temin', '_tecal', '_tecahr',
               '_tnmin', '_tncal', '_tnchar', '_timin',
               '_tical', '_ticharncsc', 'totalcal')
...
CATEGORICAL_COLS = (('voice', 2), ('intplan', 2))


CONTINUOUS_COLS = ('nummailmes', '_tdmin', '_tdcal',
				   '_tdchar', '_temin', '_tecal', '_tecahr',
				   '_tnmin', '_tncal', '_tnchar', '_timin',
				   '_tical', '_ticharncsc', 'totalcal')

LABELS = [0, 1]
LABEL_COLUMN = 'label_neu'

"""UNUSED_COLUMNS = set(CSV_COLUMNS) - set(
    list(zip(*CATEGORICAL_COLS))[0] + CONTINUOUS_COLS + (LABEL_COLUMN,))
    #CONTINUOUS_COLS + (LABEL_COLUMN,))"""
