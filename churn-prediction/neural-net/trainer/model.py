...
CSV_COLUMNS = ('st', 'nummailmes', '_tdmin', '_phnum', '_tdcal',
               '_tdchar', '_temin', '_tecal', '_tecahr',
               '_tnmin', '_tncal', '_tnchar', '_timin',
               '_tical', '_ticharncsc', 'totalcal', '_label')
...
CATEGORICAL_COLS = (('st', 16), ('marital_status', 7),
                    ('relationship', 6), ('workclass', 9), ('occupation', 15),
                    ('gender', [' Male', ' Female']), ('race', 5))

CONTINUOUS_COLS = ('nummailmes', '_tdmin', '_phnum', '_tdcal',
				   '_tdchar', '_temin', '_tecal', '_tecahr',
				   '_tnmin', '_tncal', '_tnchar', '_timin',
